...
const BuyerGr = (props) => {
    ...
    const renderItems = useCallback(({ item, index }) => {
        return (
            <TouchableOpacity
                ...
                <View style={{ position: 'absolute', bottom: -4, alignSelf: 'center', width: 87, height: 18, borderRadius: 6, backgroundColor: '#A047C8', justifyContent: 'center', alignItems: 'center' }}>
    ...
    const renderSR = useCallback(({ item, index }) => {
        return (
            <TouchableOpacity
            onPress={() => {
            ...
            >
                ...
                <View style={{ width: "85%", alignSelf: 'center', marginTop: 20 }}>
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', }}>
                        ...
                        >
                            <Text style={{ fontFamily: 'LBo', fontSize: 18, color: !sentRequest ?  '#FFFFFF': '#888888' }}>Out on Rent (8)</Text>
                        </TouchableOpacity>
                        <TouchableOpacity
                            onPress={()=>{
                                setSentRequest(true)
                        ...
                        >
                            <Text style={{ fontFamily: 'LBo', fontSize: 18, color: sentRequest ?  '#FFFFFF': '#888888' ,marginRight:30 }}>Sent Requests</Text>
                        </TouchableOpacity>
                    </View>
